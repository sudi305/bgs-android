...
public class TagsVerticalLinearLayout extends LinearLayout {

    private List<LinearLayout> mLineLayouts = new ArrayList<>();

    private float mDensity;

    public TagsVerticalLinearLayout(Context context) {
        super(context);
    ...
    public TextLineParams onTagsChanged(List<TagsView.Tags> tags) {
        clearChipsViews();
    ...
    private LinearLayout createHorizontalView() {
        ...
        ll.setPadding(0, 0, 0, (int) (TagsView.Tags_BOTTOM_PADDING * mDensity));
